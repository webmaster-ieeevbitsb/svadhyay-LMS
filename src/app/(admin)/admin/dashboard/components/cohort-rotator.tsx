    ...
    <div className="bg-[#0a0a0f] border border-white/5 rounded-3xl p-8 space-y-6 relative overflow-hidden group">
       ...
       <div className="flex items-center justify-between relative z-10">
          <div className="space-y-1">
             ...
             <h3 className="text-xl font-black italic uppercase tracking-tighter text-white">Cohort <span className="text-blue-500">Rotation</span></h3>
          </div>
          <div className="px-4 py-2 bg-blue-600/10 border border-blue-500/20 rounded-xl">
             <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">{participantCount} Active Nodes</span>
          </div>
       </div>

       <p className="text-zinc-500 text-xs font-medium leading-relaxed max-w-md relative z-10">
          Initiate yearly transition protocol. This will <span className="text-white font-bold italic uppercase">Deallocate all student records</span> while preserving administrative identities.
       </p>
            ...
            <div className="space-y-4 animate-in slide-in-from-bottom-2 duration-300">
               <div className="flex items-center gap-3 p-4 bg-red-500/5 border border-red-500/20 rounded-2xl">
                  ...
                  <p className="text-red-500/80 text-[10px] font-bold uppercase tracking-widest leading-tight">
                    Warning: This action is irreversible. All student progress and registry data will be purged.
                  </p>
               </div>

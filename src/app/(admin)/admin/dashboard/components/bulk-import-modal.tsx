...
export function BulkImportModal({ isOpen, onClose, isAdminMode = false }: { isOpen: boolean, onClose: () => void, isAdminMode?: boolean }) {
        ...
        <div className="space-y-6">
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <h2 className="text-2xl font-black italic tracking-tighter uppercase text-white">
              {isAdminMode ? "Bulk Admin CSV Upload" : "Bulk CSV Import"}
            </h2>
